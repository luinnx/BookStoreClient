...
public class AgentMyProfileActivity extends AgentActionbarBase implements
	...
	EditText tvEditAgentName, tvEditAgentEmail, tvEditMobileNumber;
	...
	public void onClick(View view) {
		if (view.getId() == R.id.ivEditAgentsProfile) {
			if (llPersonalInfo.getVisibility() == View.VISIBLE) {
				...
				ivEditAgentsProfile.setImageDrawable(getResources()
						.getDrawable(R.drawable.ic_arrow_up32));
				llEditPersonalInfo.setVisibility(View.VISIBLE);
				btnOk.setText("Submit");
			} else {
				llPersonalInfo.setVisibility(View.VISIBLE);
				ivEditAgentsProfile.setImageDrawable(getResources()
						.getDrawable(R.drawable.ic_edit_personal_info));
