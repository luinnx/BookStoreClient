...
import com.bookstore.app.adapters.AgentPendingJobListAdapter.ViewHolder;
import com.bookstore.app.entities.AgentJobList;

public class AgentSubmittedJobListAdapter extends ArrayAdapter<AgentJobList>{
	
	Context context;
	ArrayList<AgentJobList> agentJobList;
	AgentJobList agentJobListObject;

	public AgentSubmittedJobListAdapter(Context context, int resource,
